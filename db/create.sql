...
CREATE TABLE Orders(
    ...
    orders_image_url VARCHAR(500) NOT NULL REFERENCES Products(image_url),
    orders_price DECIMAL(12,2) NOT NULL REFERENCES Products(price),
    orders_name VARCHAR(255) NOT NULL REFERENCES Products(product_name)
